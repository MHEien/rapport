...
const styles = StyleSheet.create({
  ...
  colCheck: { width: "8%", textAlign: "center", borderLeftWidth: 1, borderColor: "#eee" }, // Avvik, OK, N/A
  colValue: { width: "12%", textAlign: "center", borderLeftWidth: 1, borderColor: "#eee" },
  colComment: { width: "24%", paddingLeft: 5, borderLeftWidth: 1, borderColor: "#eee", fontSize: 8 },
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {report.equipment.map((eq, index) => {
          ...
          return (
            <View key={eq.id} wrap={false} style={styles.tableContainer}>
              ...
              <View style={[styles.sectionHeader, { backgroundColor: "#ccc", marginTop: 15 }]}>
                <Text style={[styles.sectionTitle, { fontSize: 12 }]}>
                   {eq.productType}: {eq.productName} ({eq.serialNumber || "No SN"})
                </Text>
              </View>
              ...
              <View style={styles.tableHeader}>
                ...
                <Text style={[styles.colDesc, styles.boldText]}>Servicepunkt</Text>
                ...
                <Text style={[styles.colComment, styles.boldText]}>Kommentar</Text>
              </View>
              ...
              {categories.map((category) => (
                <View key={category}>
                  ...
                  {groupedChecklists[category].map((item, idx) => {
                    ...
                    const isAvvik = item.status === "BOR_UTBEDRES" || item.status === "MA_UTBEDRES";
                    ...
                    return (
                      <View key={item.id} style={styles.tableRow}>
                        ...
                        {/* Status Columns  */}
                        <Text style={styles.colCheck}>{isAvvik ? "X" : ""}</Text>
        ...
        <View style={styles.noteSection} break={false}>
          <Text style={styles.noteTitle}>Konklusjon/Notater (Felles for alle enheter):</Text>
        ...
        {/* --- Signatures --- */}
        <View style={[styles.metaGrid, { borderBottomWidth: 0, marginTop: 40 }]} break={false}>
           <View style={{ width: "50%" }}>
